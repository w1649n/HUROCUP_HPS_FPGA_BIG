...
void InverseKinematic::initial_angle_gain()
{
	...
	angle_gain_[21] = ALL_Angle_Gain * 1;
	angle_gain_[22] = ALL_Angle_Gain * 1;
}
...
void InverseKinematic::initial_speed_gain()
{
	...
	speed_gain_[21] = ALL_Speed_Gain * 1;
	speed_gain_[22] = ALL_Speed_Gain * 1;
}
...
void InverseKinematic::initial_parameters(){
	...
	Parameters.l1 = 24.8;//12.5;//10.2;             //cm Upper	10th: 12.5 11st: 10.2 robotcup: 14
	Parameters.l2 = 24.8;//12.5;//10.2;             //cm Down	10th: 12.5 11st: 10.4 robotcup: 14
...
void InverseKinematic::initial_points()
{
	...
	Points.Thta[21] = PI_2;					   //手爪
	Points.Thta[22] = PI_2; 				   //手爪
	...
	Points.P_Table[21] = 0;                     //Positive
	Points.P_Table[22] = 0;                     //Positive
	...
	thta_base_[21] = datamodule.totalangle_[21];
	thta_base_[22] = datamodule.totalangle_[22];
	//-----------------下半身角度base----------------------
...
//    }///////////////////////////////
	...
	// }
	*((uint32_t *)init.robot_motion_addr+(46)) = Motion_Delay;
