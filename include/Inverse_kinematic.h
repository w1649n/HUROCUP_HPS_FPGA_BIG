...
//#define Debug_IK
/********************************************************/
#define COM_HEIGHT 62//26.5//28.8//24.3//26.9
#define Length_Pelvis 11.8//9.1//8.7//8.7
#define Length_Leg 47.3//21 //17 //20.4
...
private:
    double speed_gain_[23];
    double angle_gain_[23];
    int angle_[23];
    int output_base_[23];
    int thta_base_[23];
    double past_thta_[23];
    double delay_time_[23];
    double past_delay_time_[23];
    unsigned int output_speed_[23];
    unsigned int output_angle_[23];
